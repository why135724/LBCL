...
# =========================
def compute_representativeness(features, n_clusters):
    ...
    # Compute cosine similarity directly. sklearn handles the cosine
    # denominator internally, so no explicit feature normalization is needed.
    sim = cosine_similarity(features, centers)
...
def URBSS(
    ...
    if need_more > 0:
        ...
        # 3.1 Use the original standardized CSP features directly.
        features = X_candidate.cpu().numpy()
...
if __name__ == "__main__":
    ...
    for dataset in ["MI1", "MI2"]:
        ...
        jsonl_path = (
            ...
            f"{dataset}_train_urbss_v3.jsonl"
        )
